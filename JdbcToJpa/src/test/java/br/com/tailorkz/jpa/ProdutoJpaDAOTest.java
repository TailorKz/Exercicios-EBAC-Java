...
import main.java.br.com.tailorkz.dao.jpa.IProdutoJpaDAO;
import main.java.br.com.tailorkz.dao.jpa.ProdutoJpaDAO;
...
public class ProdutoJpaDAOTest {
	...
	public void alterarCliente() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TableException {
		...
		Assert.assertEquals("Tailor", produtoBD.getNome());
	}
